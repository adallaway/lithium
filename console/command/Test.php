...
class Test extends \lithium\console\Command {
	 ...
	 * For example:
	 * ```sh
	 * lithium test lithium/tests/cases/core/BaseObjectTest.php --filters=Coverage
	 * lithium test lithium/tests/cases/core/BaseObjectTest.php --filters=Coverage,Profiler
	 * ```
	 *
	 ...
	 *
	 * ```sh
	 * li3 test lithium/tests/cases/core/BaseObjectTest.php
	 ...
	 *
	 * ```
	 * lithium/tests/cases/core/BaseObjectTest.php -> lithium\tests\cases\core\BaseObjectTest
	 * lithium/tests/cases/core                    -> lithium\tests\cases\core
	 * lithium/core/BaseObject.php                 -> lithium\core\BaseObject
